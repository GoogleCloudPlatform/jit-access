...
public class TestAccessControlList {
  private static final UserEmail TEST_USER = new UserEmail("test-1@example.com");
  private static final UserEmail TEST_USER_OTHER = new UserEmail("test-2@example.com");
