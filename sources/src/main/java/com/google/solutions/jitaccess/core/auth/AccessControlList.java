...
public record AccessControlList(
  ...
  private static boolean isAllowed(
    @NotNull Iterable<PrincipalIdentifier> principals,
   ...
   */
  public Set<PrincipalIdentifier> allowedPrincipals(int requiredAccessRights) {
    //
  ...
  public static abstract class Entry {
     ...
     */
    public final @NotNull PrincipalIdentifier principal;

    protected Entry(@NotNull PrincipalIdentifier principal, int accessRights) {
  ...
  public static class AllowedEntry extends Entry {
    public AllowedEntry(@NotNull PrincipalIdentifier principal, int accessMask) {
  ...
  public static class DeniedEntry extends Entry {
    public DeniedEntry(@NotNull PrincipalIdentifier principal, int accessMask) {
      super(principal, accessMask);
    }
  ...
  public static class Builder {
    ...
    public Builder allow(PrincipalIdentifier principal, int accessMask) {
      this.entries.add(new AllowedEntry(principal, accessMask));
      return this;
    }

    public Builder deny(PrincipalIdentifier principal, int accessMask) {
